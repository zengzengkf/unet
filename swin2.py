...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, patch_size=4, in_c=3, embed_dim=96):
        super().__init__()
...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask: Optional[torch.Tensor] = None):
        ...
        relative_position_bias = self.relative_position_bias_table[self.relative_position_index.view(-1)].view(
            self.window_size[0] * self.window_size[1], self.window_size[0] * self.window_size[1], -1)#相对位置信息
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=(7,7), shift_size=(0,0),
        ...
        self.attn = WindowAttention(
            dim, window_size=(self.window_size[0], self.window_size[1]), num_heads=num_heads, qkv_bias=qkv_bias,
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, depth, num_heads, window_size,H,W,
        ...
        self.shift_size = [0,0]
        self.shift_size[0] = window_size[0] // 2
        self.shift_size[1] = window_size[1] // 2
    ...
    def forward(self, x):
        ...
        if self.downsample is not None:
            ...
            H, W = (H + 1) // 2, (W + 1) // 2
        x = x.view(-1, self.window_size[0], self.window_size[1], x.shape[-1])
